"""
Django settings for fire_noc_project project.
...
SECRET_KEY = 'django-insecure-ammjkn0q$m)cgi@e5=v$d!6=^(g8*8k_u39jw-@1dd5eh-o8g*'
...
ROOT_URLCONF = 'fire_noc_project.urls'
...
WSGI_APPLICATION = 'fire_noc_project.wsgi.application'
